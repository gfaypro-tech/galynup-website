...
$stmt = $db->prepare("SELECT question, answer FROM cv_dialogue WHERE application_id = ? AND answer != '' AND answer IS NOT NULL ORDER BY question_order");
$stmt->execute([$id]);
...
$ins = $db->prepare("INSERT INTO cv_knowledge (type, title, content, meta_json) VALUES ('experience', ?, ?, ?)");
