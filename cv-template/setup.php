...
<body>
  ...
  <?php if ($hash): ?>
    ...
    <div class="instructions">
      ...
      2. Ouvre <code>config.php</code> via FTP<br>
      3. Colle le hash dans <code>CV_PASSWORD_HASH</code><br>
      4. <strong>Supprime ce fichier setup.php du serveur immédiatement</strong>
    </div>
  <?php endif; ?>
</body>
</html>
