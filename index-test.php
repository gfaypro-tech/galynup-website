...
<head>
    ...
    <link rel="stylesheet" href="css/style-test.css?v=3.0.0-glassmorphism">
...
<body class="page-index">
    ...
    <!-- Compétences Section avec grille de cartes -->
    <section id="competences" class="section section-gray">
        <div class="container">
            <div class="section-header">
            ...
            <div class="competences-grid">
                ...
                <!-- Carte Strategy@HEC -->
                <div class="cert-competence-card" id="cert-strategy">
                ...
                <!-- Carte TOGAF -->
                <div class="cert-competence-card" id="cert-togaf">
                    <svg class="cert-detail-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                        <rect x="3" y="3" width="18" height="18" rx="2"/>
                        <path d="M3 9h18M9 21V9"/>
                    </svg>
                ...
                <!-- Carte ITIL -->
                <div class="cert-competence-card" id="cert-itil">
                    <svg class="cert-detail-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                        <circle cx="12" cy="12" r="3"/>
                        <path d="M12 1v6m0 6v6M5.64 5.64l4.24 4.24m4.24 4.24l4.24 4.24M1 12h6m6 0h6M5.64 18.36l4.24-4.24m4.24-4.24l4.24-4.24"/>
                    </svg>
                ...
                <!-- Carte PMP -->
                <div class="cert-competence-card" id="cert-pmp">
                    <svg class="cert-detail-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                        <path d="M3 3v18h18"/>
                        <path d="M18 17V9M13 17v-6M8 17v-3"/>
                    </svg>
                ...
                <!-- Carte ACP -->
                <div class="cert-competence-card" id="cert-acp">
                    <svg class="cert-detail-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                        <path d="M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16z"/>
                        <polyline points="7.5 4.21 12 6.81 16.5 4.21"/>
                        <polyline points="7.5 19.79 7.5 14.6 3 12"/>
                ...
                <!-- Carte ASF -->
                <div class="cert-competence-card" id="cert-asf">
                    <svg class="cert-detail-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                        <polyline points="22 12 18 12 15 21 9 3 6 12 2 12"/>
                    </svg>
                    <h2>ASF</h2>
                ...
                <div class="contact-form-card">
                    ...
                    <div class="contact-info">
                        ...
                        <div class="contact-item">
                            ...
                            <a href="/cdn-cgi/l/email-protection#385f595d54545d165e5941785f595441564d48165e4a"><span class="__cf_email__" data-cfemail="b8dfd9ddd4d4dd96ded9c1f8dfd9d4c1d6cdc896deca">[email&#160;protected]</span></a>
                        </div>
                        <div class="contact-item">
                            <svg class="contact-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
